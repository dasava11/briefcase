...
const Header = () => {
  return (
    <div className="my-11">
      <h1 className="text-3xl font-bold ">Hola, Soy David Sánchez Vargas</h1>
      <p className="text-center mt-3 mx-6 py-2 px-10">
        Te presento mi portafolio, el cual te permitirá ver los conocimientos,
        aptitudes y experiencias que poseo y he aplicado en los proyectos que
        encuentras acá.
      </p>{" "}
      <p className="text-center mt-3 mx-6  py-2 px-10">
        Soy una persona con sed de conocimiento, proactivo, perseverante, con
        capacidad de análisis, adaptabilidad y aprendizaje continuo. Estás
        características me han direccionado a incursionar en el mundo del
        desarrollo de software, formándome como desarrollador FullStack, que a
        partir de esta base estoy interesado en especializarme como FrontEnd.
      </p>{" "}
      <p className="text-center mt-3 mx-6  py-2 px-10">
        Soy <span className="font-bold">desarrollador FullStack</span> con background
